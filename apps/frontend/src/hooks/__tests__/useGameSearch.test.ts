...
import { useGameSearch, buildFilterParams, type SearchFilters, DEFAULT_FILTERS } from "../useGameSearch";
...
describe("useGameSearch", () => {
  ...
  // ─── Hook existence ────────────────────────────────────
  it("should export useGameSearch as a function", () => {
